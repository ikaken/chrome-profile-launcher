...
**[最新版のダウンロードはこちら (ChromeProfileLauncher-win-Setup.exe)](https://github.com/ikaken/chrome-profile-launcher/releases/download/v0.1.5-beta/ChromeProfileLauncher-win-Setup.exe)**
