...
**[Download Latest Version (ChromeProfileLauncher-win-Setup.exe)](https://github.com/ikaken/chrome-profile-launcher/releases/download/v0.1.16-beta/ChromeProfileLauncher-win-Setup.exe)**

*Note: Automatically points to the latest release (v0.1.16-beta).*
...
**[最新版のダウンロードはこちら (ChromeProfileLauncher-win-Setup.exe)](https://github.com/ikaken/chrome-profile-launcher/releases/download/v0.1.16-beta/ChromeProfileLauncher-win-Setup.exe)**

*※v0.1.16-betaへのリリース対応済み。ダウンロードリンクは自動的に最新のリリースを指します。*
