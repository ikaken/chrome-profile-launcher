...
**[最新版のダウンロードはこちら (ChromeProfileLauncher-win-Setup.exe)](https://github.com/ikaken/chrome-profile-launcher/releases/download/v0.1.8-beta/ChromeProfileLauncher-win-Setup.exe)**

*※v0.1.8-betaへのリリース対応済み。ダウンロードリンクは自動的に最新のリリースを指します。*
